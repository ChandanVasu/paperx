<div class='singlepost1-vasutheme'>

<div class="post-content-single1">
    ...
    <h1 class="post-title-single1"><?php the_title(); ?></h1>
    
    <?php if (has_excerpt()) : ?>
        <div class="post-excerpt-single1">
            <?php the_excerpt(); ?>
        </div>
    <?php endif; ?>

      <div class='author-and-shear-single1'>
        
        <div class='author-and-shear-single1-author'><?php get_template_part('Template/author-info'); ?></div>
      
      </div>

    <?php if (has_post_thumbnail()) : ?>
        <div class="post-thumbnailss-single1">
