...
<body>
  ...
  <img onclick="callhamber()" class="image-menu-icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/Assets/Image/menu.png" alt="">

  <div class='hambermenu-main-contant' id='hambermenu-main-contant'>

    <div class='header-under-hamber-menu'>
      ...
      <img onclick="callhamber()" class="image-menu-close-icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/Assets/Image/close.png" alt="">
